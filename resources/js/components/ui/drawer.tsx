...
const Drawer = (props: ComponentProps<typeof Vaul.Root>) => (
    <Vaul.Root data-slot='drawer' {...props} />
)
...
const DrawerPortal = (props: ComponentProps<typeof Vaul.Portal>) => (
    <Vaul.Portal data-slot='drawer-portal' {...props} />
)

const DrawerClose = (props: ComponentProps<typeof Vaul.Close>) => (
    <Vaul.Close data-slot='drawer-close' {...props} />
)
...
const DrawerContent = ({
    ...
    <DrawerPortal data-slot='drawer-portal'>
        ...
        >
            ...
            {children}
            <div className='mx-auto mb-4 hidden h-2 w-25 shrink-0 rounded-full bg-muted group-data-[vaul-drawer-direction=top]/drawer-content:block' />
        </Vaul.Content>
    </DrawerPortal>
)
