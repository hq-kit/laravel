...
import { useDataParams } from '@/hooks/use-data-params'
...
export default function Index({ users, filters, roles }: Props) {
    ...
    const { params, updateParams, onSortChange, sortDescriptor } = useDataParams(
        users.meta.path,
        {
    ...
    const filterOptions = [
        {
            ...
            defaultValue: filters?.role?.split(',') || [],
        },
    ]
                ...
                <CardContent>
                    ...
                    >
                        <TableHeader>
                            ...
                            <TableColumn id='role'>Roles</TableColumn>
